...
const features = [
  ...
  },
  {
    ...
    description: 'Forget manual sorting. Expense Tracker automatically categorizes your expenses, saving you time and effort.',
  },
  {
    icon: <BarChart />,
      ...
      <header className="sticky top-0 z-40 w-full border-b bg-card/80 backdrop-blur-sm">
        <div className="container flex h-16 items-center justify-between px-4 md:px-6">
          <Link href="/" className="flex items-center gap-2 text-xl font-bold text-primary md:text-2xl">
            ...
            <span className="font-headline">Expense Tracker</span>
          </Link>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Expense Tracker is packed with features designed to make financial management easy and intuitive.
                </p>
              </div>
            </div>
